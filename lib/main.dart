...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      ...
      home: HomePage(), // Set the initial screen directly
    );
  }
}
            ...
            onPressed: () {
              showMenu<int>(
                ...
                if (value == 1) {
                  ...
                  bufferPopup.showBufferPopup(context, 'Logging Out..',
                      resource().PresentWorkingUser, 'Logged Out ');
        ...
        child: Stack(
          ...
          children: [
                  ...
                  return Container(
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(
                          50), // Optional: to make the background rounded like the icon
                    ),
                    child: IconButton(
                      icon: const Icon(
                        Icons.person,
            ...
            Positioned(
              top: 340,
              left: 150,
              child: Consumer<resource>(builder: (context, resource, child) {
                return Container(
                  decoration: BoxDecoration(
                    gradient: const LinearGradient(
                      colors: [
                  ...
                  child: IconButton(
                    icon: const Icon(Icons.emoji_events,
                        size: 40,
                        color: Colors
                            .white), // Icon color should be white for better visibility
                    onPressed: () {
                      String presentUser = resource.PresentWorkingUser;
                      if (presentUser == 'default') {
                        obj_popup.showPopup(context, "Please Login", "");
            ...
            Positioned(
              ...
              child: Column(
                ...
                children: [
                  Consumer<resource>(builder: (context, resource, child) {
            ...
            Positioned(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Consumer<resource>(builder: (context, resource, child) {
                    return buildIconButtonWithBorder(Icons.add_a_photo,
                        () async {
                      print("camera button pressed");
                      {
                        try {
                          ...
                          BufferPopup bufferPopup = BufferPopup();
                          bufferPopup.showBufferPopup(context, 'Uploading...',
                              'Please wait', 'Uploaded');

                          // Perform your image upload or processing logic here
                          await Future.delayed(
                              Duration(seconds: 1)); // Simulate processing
  ...
  return Container(
    ...
    child: IconButton(
      icon: Icon(icon,
          size: 30,
          color:
              const Color.fromARGB(255, 223, 225, 251)), // Icon color is orange
      onPressed: onPressed,
    ),
  );
}
    ...
    return Scaffold(
      ...
      body: Center(
        child: ElevatedButton(
          onPressed: () {
            showPopup(context, "popup Example",
                'The content will be displayed here'); // Call the popup function
          },
...
class ParticipantListView extends StatelessWidget {
  final List<String> participants =
      List.generate(100, (index) => "Participant ${index + 1}");
        ...
        children: [
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        shadows: [
                          Shadow(
                            color: const Color.fromARGB(255, 166, 22, 22)
                                .withOpacity(0.5),
                            offset: Offset(2, 2),
                            blurRadius: 4,
                          ),
          ...
          NotificationListener<ScrollNotification>(
            ...
            child: Padding(
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  children:
                      awards.map((award) => AwardCard(award: award)).toList(),
                ),
              ),
            ),
          ),
          ...
          Padding(
            padding: const EdgeInsets.only(
                left: 10, top: 0), // Adjust padding as needed
            child: Row(
              children: [
                Stack(
                  alignment: Alignment.centerLeft,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Tapped on ${award.name}')),
        );
      },
      child: Card(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      _buildSocialIcon(
                          ...
                          Colors.lightBlue,
                          "https://twitter.com"), // Twitter icon
                      const SizedBox(width: 15),
                      _buildSocialIcon(FontAwesomeIcons.instagram, Colors.pink,
                          "https://instagram.com"),
                      const SizedBox(width: 15),
                      _buildSocialIcon(FontAwesomeIcons.linkedin,
                          Colors.blueAccent, "https://linkedin.com"),
                    ],
                  ),
                ],
              ),
