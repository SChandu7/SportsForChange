...
class NotificationsTab extends StatelessWidget {
  ...
  const NotificationsTab({super.key, required this.type});
...
class SchoolsHomePage extends StatefulWidget {
  const SchoolsHomePage({super.key});
...
class SchoolDetailsPage extends StatelessWidget {
  ...
  const SchoolDetailsPage({super.key, required this.schoolName, required this.activities});
...
class ActivityFormSheet extends StatefulWidget {
  ...
  const ActivityFormSheet({super.key, required this.schools, required this.onSubmit});
